defmodule Receipts.Repo.Migrations.AddWinLossAnalysisCache do
  use Ecto.Migration

  def change do
    create table(:lol_win_loss_analyses, primary_key: false) do
    ...
    create(index(:lol_win_loss_analyses, [:cache_key, :generated_at]))
  end
end
