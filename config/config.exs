...
config :receipts, ReceiptsWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ReceiptsWeb.ErrorHTML, json: ReceiptsWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Receipts.PubSub,
  live_view: [signing_salt: "5reIYivs"]
...
config :receipts, Receipts.Mailer, adapter: Swoosh.Adapters.Local
