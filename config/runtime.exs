...
config :receipts, :discord,
  application_id: get_env.("DISCORD_APPLICATION_ID"),
  bot_token: get_env.("DISCORD_BOT_TOKEN"),
  public_key: get_env.("DISCORD_PUBLIC_KEY")

config :receipts, :gemini, api_key: get_env.("GEMINI_API_KEY")
...
#
#     PHX_SERVER=true bin/receipts start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if get_env.("PHX_SERVER") do
  config :receipts, ReceiptsWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :receipts, Receipts.Mailer,
